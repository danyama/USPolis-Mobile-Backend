...
export const mapResults = async (prisma: PrismaClient, results: ListedEvent[]) => {
  return Promise.all(results
    .filter((element) => element._id.created_by === "amelia" || element._id.created_by === "eletrica-manual" || element._id.created_by === "producao-manual" || element._id.created_by === "civil-manual")
